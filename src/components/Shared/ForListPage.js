...
class ForListPage extends Component {
  ...
  renderTableBody = () => {
    ...
    return (
      <tbody>{data.length > 0 ? renderTableData() : renderEmptyTable()}</tbody>
    );
  };
        ...
        <td className="table-dropdown-menu-wrapper">
          ...
          <ul className="table-dropdown-menu">
            <li className="table-dropdown-menu-item">
              <Link to={`/${entityName}/xem-thong-tin/${record[idColumn]}`}>
                Xem thông tin
              </Link>
            </li>
    ...
    return (
      <div className="table-pagination">
        ...
        <div className="table-pagination__right">
          ...
          <label className="table-pagination__label"> / {totalPages}</label>

          <span className="table-pagination__button" onClick={showPrevPage}>
            <i className="fas fa-chevron-left"></i>
          </span>
          <span className="table-pagination__button" onClick={showNextPage}>
            <i className="fas fa-chevron-right"></i>
          </span>
        </div>
      </div>
